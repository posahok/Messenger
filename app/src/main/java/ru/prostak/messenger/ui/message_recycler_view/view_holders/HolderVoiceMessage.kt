...
import ru.prostak.messenger.utilits.AppVoicePlayer
...
class HolderVoiceMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    override fun drawMessage(view: MessageView) {
        if (view.from == CURRENT_UID) {
            this.blocReceivedVoiceMessage.visibility = View.GONE
            this.blocUserVoiceMessage.visibility = View.VISIBLE

            this.chatUserVoiceMessageTime.text = view.timeStamp.asTime()

        } else {
            this.blocReceivedVoiceMessage.visibility = View.VISIBLE
            this.blocUserVoiceMessage.visibility = View.GONE

            this.chatReceivedVoiceMessageTime.text = view.timeStamp.asTime()
        }
    }
